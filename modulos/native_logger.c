/*
 * native_logger.c — puente JNI usado por la instrumentación "sin root" de
 ...
 * thread detached, no bloquea al caller. Se compila con el clang de Termux
 * (target por defecto aarch64-unknown-linux-android, Bionic real — el mismo
 * libc que usa cualquier app Android) directo en el dispositivo, sin NDK.
 */
#include <jni.h>
...
Java_com_kairos_logger_RemoteLogger_nativeSendLog(
    JNIEnv *env,
    jclass clazz,
    jstring jlevel,
    jstring jtag,
