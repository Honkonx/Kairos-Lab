...
public class TermuxTerminalExtraKeys extends TerminalExtraKeys {
    ...
    /**
     * Vuelve a leer la config de extra-keys ("extra-keys"/"extra-keys-style" de
     * termux.properties) y reconstruye {@link #mExtraKeysInfo}. Antes esta lectura
     * pasaba SOLO por el constructor, así que si el usuario editaba su matrix de
     * extra-keys (ej. pasar de 1 a 2 filas) y pedía un reload de estilo SIN recrear
     * la activity (ACTION_RELOAD_STYLE con EXTRA_RECREATE_ACTIVITY=false), el objeto
     * quedaba con la matrix vieja en memoria para siempre — TermuxActivity necesita
     * poder pedir este refresh antes de recalcular la altura del toolbar y volver a
     * pintar el ExtraKeysView, para que ambos usen el mismo número de filas real.
     */
