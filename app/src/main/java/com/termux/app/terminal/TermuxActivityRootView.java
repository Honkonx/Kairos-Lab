...
public class TermuxActivityRootView extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public static class WindowInsetsListener implements View.OnApplyWindowInsetsListener {
        ...
        public WindowInsets onApplyWindowInsets(View v, WindowInsets insets) {
            ...
            // TÁCTILMENTE el botón ☰ (confirmado con QuickPanelLog/SHADE interceptando el tap
            // como gesto de "abrir panel de notificaciones"). Fallback estándar de Android para
            // este caso: el recurso de sistema "status_bar_height", el mismo mecanismo que usan
            // AppCompat/Material internamente antes de que WindowInsets exista como API.
            ...
            // Android (notif/batería/wifi/señal) tapaba la primera línea de la terminal
            // (output "hello") y la barra adaptada (Minimizar/Cerrar/estado). Se aplica el
            // padding manualmente al root para desplazar todo el contenido debajo de la
            // barra de estado. El fondo del root (kairos_bg) pinta la franja translúcida.
            v.setPadding(0, mStatusBarHeight, 0, 0);
            // Devolver los insets sin consumir para que el sistema pueda seguir
            // despachándolos a los hijos si algún hijo los necesita en el futuro.
            return insets;
        }
    }
