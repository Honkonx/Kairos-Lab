...
public class LoriePreferences extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Kairos: en el embed LoriePreferences se abre como actividad standalone de
        // preferencias (patrón termux-x11 oficial). En linbox el fragment lo montaba el panel
        // de la TermuxActivity host. Se monta acá salvo cuando esta clase es la MainActivity
        // del visor (que setea su propio layout). Ver docs/x11/X11_EMBEBIDO.md.
    ...
    public static class LoriePreferenceFragment extends PreferenceFragmentCompat implements OnPreferenceChangeListener, Preference.OnPreferenceClickListener {
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            // Kairos: en el embed la pantalla de preferencias es una actividad standalone, sin
            // TermuxActivity host. Para que los cambios apliquen en vivo se reemite el broadcast
            // ACTION_PREFERENCES_CHANGED que MainActivity (visor) ya escucha → onPreferencesChanged().
            // setPackage("com.termux") = el paquete de Kairos. Ver docs/x11/X11_EMBEBIDO.md.
